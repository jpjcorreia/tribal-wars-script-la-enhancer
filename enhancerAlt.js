var keyToEdit,
  ...
  scriptURL = "https://github.com/jpjcorreia/tribal-wars-script-la-enhancer/blob/master/",
  updateNotesURL =
  ...
  sitter = "";
"0" != window.top.game_data.player.sitter &&
...
var userset,
  ...
  keycodes = { a: 65, b: 66, c: 67, skip: 83, right: 39, left: 37, master: 77 },
  keyPressSettings = {
    a_code: 65,
    a_char: "A",
    b_code: 66,
...
function checkVersion() {
  if (getVersion() != version)
    if (
      ((buttons = [{ text: "OK", callback: null, confirm: !0 }]), clearProfiles)
    ) {
...
function checkWorking() {
  ...
  null == e && window.top.$.jStorage.set("working", !1),
    ...
    0 == working &&
      0 == e &&
      ((buttons = [{ text: "OK", callback: null, confirm: !0 }]),
...
function showAllRows() {
  ...
  "max" == window.top.$("#end_page").val() && window.top.$("#end_page").text(e),
    ...
    e > parseInt(window.top.$("#end_page").val(), 10) &&
      (e = parseInt(window.top.$("#end_page").val(), 10)),
    setTimeout(function () {
  ...
  window.top.$.ajax({
    ...
    success: function (e) {
      var t = window.top.$(e),
        ...
        i = window.top.$.parseJSON(
          e.split("TribalWars.updateGameData(")[1].split(");")[0]
        );
      (window.top.game_data = i),
        ...
        window.top
          .$("#header_info")
          .html(window.top.$("#header_info", t).html()),
        window.top
          .$("#topContainer")
          .html(window.top.$("#topContainer", t).html()),
        window.top
          .$("#contentContainer")
          .html(window.top.$("#contentContainer", t).html()),
        window.top
          .$("#quickbar_inner")
          .html(window.top.$("#quickbar_inner", t).html()),
    ...
    window.top
      .$(
        "#language option[value='" +
          window.top.$.jStorage.get("language") +
          "']"
      )
...
function setOnclick(e) {
  ...
  if (void 0 !== t) {
    var o = t.slice(t.indexOf("(") + 1, t.indexOf(")")),
      i = o.split(",");
    -1 == t.indexOf("FromReport")
      ? e
          .find("a")
          .attr(
            "onclick",
            "return customSendUnits(" + o + ", window.top.$(this))"
          )
      : e
          .find("a")
          .attr("onclick", "return customSendUnitsFromReport(" + o + "))"),
...
function checkIfNextVillage() {
  if (
    ...
    current_units.spy <= parseInt(userset[s.scouts_left])
  )
    return getNewVillage("n"), !0;
  if (userset[s.next_village_farming_troops]) {
    var o = 0;
    if (
      (window.top.$(".fm_unit input:checked").each(function (e) {
  ...
  if (
    userset[s.next_village_no_farms] &&
    0 == window.top.$("#plunder_list tr:not(:first-child):visible").length
  )
    return getNewVillage("n"), !0;
}
function applySettings() {
  pagesLoaded
    ? applyFilters()
    : (setTimeout(showAllRows(), 1), removeFirstPage());
}
function applyFilters() {
  ...
  var e = 0;
  "fixed" == window.top.$("#topContainer").css("position") &&
    (e = window.top.$("#topContainer").height()),
    window.top.$('*:contains("Bot Protection")').length
      ? (window.top
          .$("html, body")
          .animate(
            {
              scrollTop:
                window.top.$('*:contains("Bot Protection")').offset().top - e,
            },
            500
          ),
...
function checkRowToHide(e, t) {
  return (
    ...
    !!hideRow &&
      (troubleshoot &&
        console.log(e.find("#rowNum").html() + ": (" + reason.join(",") + ")"),
      (reason = []),
      !0)
  );
}
...
function reportSettings(e, t) {
  return 0 <= e.html().indexOf("blue") && t[s.blue]
    ? (reason.push("Report is blue"), void (hideRow = !0))
    : 0 <= e.html().indexOf("green") && t[s.green]
    ? (reason.push("Report is green"), void (hideRow = !0))
    : 0 <= e.html().indexOf("yellow") && t[s.yellow]
    ? (reason.push("Report is yellow"), void (hideRow = !0))
    : 0 <= e.html().indexOf("red_yellow") && t[s.red_yellow]
    ? (reason.push("Report is red_yellow"), void (hideRow = !0))
    : 0 <= e.html().indexOf("red_blue") && t[s.red_blue]
    ? (reason.push("Report is red_blue"), void (hideRow = !0))
    : 0 <= e.html().indexOf("red") && t[s.red]
    ? (reason.push("Report is red"), void (hideRow = !0))
    : void 0;
}
function haulSettings(e, t) {
  if (t[s.enable_hauls]) {
    if (0 <= e.html().indexOf("max_loot/1") && t[s.full])
      return reason.push("Haul is full"), void (hideRow = !0);
    if (0 <= e.html().indexOf("max_loot/0") && t[s.partial])
      return reason.push("Haul is partial"), void (hideRow = !0);
    if (-1 == e.html().indexOf("max_loot") && t[s.full])
      return reason.push("No haul graphic"), void (hideRow = !0);
  }
}
function hideRecentlyFarmed(e, t) {
  if (t[s.hide_recent_farms]) {
    ...
    localTitle =
      "sitter:" + sitter + ", village:" + o + ", world:" + getURL()[0];
    ...
    switch (t[s.sent_time_filter]) {
      case "hide":
        if (r < parseInt(t[s.hide_recent_time]))
          return (
            reason.push("Village was recently sent to " + r + " minutes ago"),
            void (hideRow = !0)
          );
        break;
      case "show":
        if (r > parseInt(t[s.hide_recent_time]))
          return (
            reason.push("Village was not recently sent to"), void (hideRow = !0)
          );
    }
  }
}
function attackSettings(e, t) {
  ...
  if (
    ((o =
      void 0 !== i.prop("tooltipText")
        ? parseInt(i.prop("tooltipText").replace(/\D/g, ""))
        : 0),
    t[s.enable_attacks])
  )
    switch (t[s.attack_operator]) {
      case "greater_than":
        if (o > parseInt(t[s.attack_value]))
          return (
            reason.push("Outgoing attacks is too many"), void (hideRow = !0)
          );
        break;
      case "less_than":
        if (o < parseInt(t[s.attack_value]))
          return (
            reason.push("Outgoing attacks is too few"), void (hideRow = !0)
          );
        break;
      case "equal_to":
        if (o == parseInt(t[s.attack_value]))
          return reason.push("Outgoing attacks is equal"), void (hideRow = !0);
    }
}
function continentSettings(e, t) {
  ...
  if (void 0 !== o) {
    ...
    if (0 <= window.top.$.inArray(o, i) && "hide" == t[s.continent_display])
      return reason.push("Continent is set to hide"), void (hideRow = !0);
    if (-1 == window.top.$.inArray(o, i) && "show" == t[s.continent_display])
      return reason.push("Continent is not set to show"), void (hideRow = !0);
  }
}
    ...
    switch (t[s.attack_time_filter]) {
      case "hide":
        if (r < parseInt(t[s.time_value]))
          return (
            reason.push("Village attacked " + r + " minutes ago."),
            void (hideRow = !0)
          );
        break;
      case "show":
...
function scoutReportSettings(e, t) {
  ...
  if (t[s.enable_scout]) {
    if ("?" == window.top.$.trim(e.find("span").html())) o = 0;
      ...
      o =
        parseInt(e.children("span").eq(0).html().replace(/\D+/g, "")) +
        parseInt(e.children("span").eq(1).html().replace(/\D+/g, "")) +
        parseInt(e.children("span").eq(2).html().replace(/\D+/g, ""));
    switch (t[s.scout_report_operator]) {
      case "greater_than":
        if (o > parseInt(t[s.haul_value]))
          return reason.push("Too many resources"), void (hideRow = !0);
        break;
      case "less_than":
        if (o < parseInt(t[s.haul_value]))
          return reason.push("Not enough resources"), void (hideRow = !0);
        break;
      case "equal_to":
        if (o == parseInt(t[s.haul_value]))
          return reason.push("Exact resources"), void (hideRow = !0);
    }
  }
}
function wallSettings(e, t) {
  if (t[s.enable_walls]) {
    ...
    switch (("?" == o && (o = 0), window.top.$.trim(t[s.wall_operator]))) {
      case "greater_than":
        if (o > parseInt(t[s.wall_value]))
          return reason.push("Wall too high"), void (hideRow = !0);
        break;
      case "less_than":
        if (o < parseInt(t[s.wall_value]))
          return reason.push("Wall too low"), void (hideRow = !0);
        break;
      case "equal_to":
        if (o == parseInt(t[s.wall_value]))
          return reason.push("Wall is exact"), void (hideRow = !0);
    }
  }
}
    ...
    switch (window.top.$.trim(t[s.distance_operator])) {
      case "greater_than":
        if (parseFloat(o) > parseFloat(t[s.distance_value]))
          return reason.push("Village too far"), void (hideRow = !0);
        break;
      case "less_than":
        if (parseFloat(o) < parseFloat(t[s.distance_value]))
          return reason.push("Village too close"), void (hideRow = !0);
        break;
      case "equal_to":
        if (parseFloat(o) == parseFloat(t[s.distance_value]))
          return reason.push("Village exact distance"), void (hideRow = !0);
    }
  }
}
      ...
      .each(function (e) {
        4 == e &&
          ...
          (localTitle =
            ...
            ", world:" +
            getURL()[0]),
          null != window.top.$.jStorage.get(localTitle) &&
...
function getVillageAttackedTime(e) {
  for (var t, o, i = (c = e.html()).split(" "), n = 0; n < i.length; n++)
    -1 < (e = window.top.$.trim(i[n])).indexOf(".")
      ? (t = e)
      : e == filter_61
      ? (t = filter_61)
      : e == filter_62 && (t = filter_62),
      -1 < e.indexOf(":") && (o = e);
...
function loadDefaultProfile() {
  null == window.top.$.jStorage.get("profile:" + profile_10) &&
...
function createProfile() {
  ...
  if (-1 != window.top.$.inArray(e, window.top.$.jStorage.get("profileList")))
    return alert(dialog_04), createProfile(), !1;
...
function exportProfile() {
  ...
  if (e == profile_10) alert(dialog_07);
    ...
    prompt(
      dialog_08,
      dialog_09A + "" + e + dialog_09B + e + "," + t + dialog_09C
    );
}
...
function tryClick(e) {
  cansend &&
    ...
    (checkIfNextVillage() ||
      (console.log(e.html()),
      e.hasClass("farm_icon_disabled") || null == e.html()
...
function editKey(e) {
  if (
    (e.keyCode <= 37 && 40 <= e.keyCode) ||
    (e.keyCode <= 48 && 90 <= e.keyCode)
  )
    window.top.UI.ErrorMessage(
    ...
    switch (
      (37 == e.keyCode && (t = "Ã¢â€ Â"),
      38 == e.keyCode && (t = "Ã¢â€ â€˜"),
      39 == e.keyCode && (t = "Ã¢â€ â€™"),
      40 == e.keyCode && (t = "Ã¢â€ â€œ"),
      keyToEdit)
    ) {
      case "A":
    ...
    window.top.UI.SuccessMessage(
      t + " is now mapped to the " + keyToEdit + " button."
    ),
...
function updateKeypressSettings() {
  (keyPressSettings.a_code = keycodes.a),
    ...
    (keyPressSettings.priorityOneProfile = window.top
      .$("#priorityOneProfile")
      .val()),
    (keyPressSettings.priorityOneButton = window.top
      .$("#priorityOneButton")
      .val()),
    ...
    (keyPressSettings.priorityTwoProfile = window.top
      .$("#priorityTwoProfile")
      .val()),
    (keyPressSettings.priorityTwoButton = window.top
      .$("#priorityTwoButton")
      .val()),
...
function fillKeypressSettings() {
  null == window.top.$.jStorage.get("keyPressSettings") &&
    window.top.$.jStorage.set("keyPressSettings", keyPressSettings),
    ...
    window.top
      .$("#priorityOneProfile")
      .val(keyPressSettings.priorityOneProfile),
    ...
    window.top
      .$("#priorityTwoProfile")
      .val(keyPressSettings.priorityTwoProfile),
...
function selectMasterButton(e) {
  ...
  switch (
    ((t = keyPressSettings.defaultButton),
    keyPressSettings.priorityThreeEnabled &&
      !checkRowToHide(e, n) &&
      (t = keyPressSettings.priorityThreeButton),
    keyPressSettings.priorityTwoEnabled &&
      !checkRowToHide(e, i) &&
      (t = keyPressSettings.priorityTwoButton),
    keyPressSettings.priorityOneEnabled &&
      !checkRowToHide(e, o) &&
      (t = keyPressSettings.priorityOneButton),
    t)
  ) {
    case "A":
      tryClick(r);
...
function parseBool(e) {
  return (
    void 0 !== e &&
    "true" === e.replace(/^\s+|\s+window.top.$/g, "").toLowerCase()
  );
}
function getURL() {
...
function uglyHider(e) {
  ...
  (t = 0 < window.top.$("#settingsBody").length ? 2 : 1),
    "+" === window.top.$(e).text()
      ? window.top.$(e).text("-")
      : window.top.$(e).text("+"),
    0 == parseInt(window.top.$(e).attr("num"))
      ? window.top
          .$("#contentContainer")
          .find('div[class="vis"]')
          .eq(t)
          ...
          .eq(1)
          .toggle()
      : 1 == parseInt(window.top.$(e).attr("num"))
      ? window.top.$("#plunder_list_filters").toggle()
      : 2 == parseInt(window.top.$(e).attr("num")) &&
